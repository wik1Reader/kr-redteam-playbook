...
* [SMTP Gophish (Digital Ocean + Postfix )](infrastructure/smtp-do.md)
* [SMTP GoPhish (AWS + ZOHO)](infrastructure/smtp-aws-zoho.md)
* [인프라 구축 자동화](infrastructure/infra-setup-automation/README.md)
  * [테라폼 (Terraform)](infrastructure/infra-setup-automation/terraform.md)
  * [SMTP 테라폼 자동화](infrastructure/infra-setup-automation/mail-terraform.md)
